...
## Project Structure
    ...
    ├── testapiautoconnect_112296  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112296`
...
2. Clone this repo and `cd testapiautoconnect_112296`
